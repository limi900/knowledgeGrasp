...
## Features:
* The game provides dynamic, relevant questions utilizing OpenAI's API to generate focused questions based on given subtopics
* Users are able to create and log in to their accounts' to access previously created mazes
* For each correctly answered question, users will earn points and are able to revisit frequently missed questions
